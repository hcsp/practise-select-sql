...
// +----------+-----------+------------+-------------+
    public static List<Order> getInnerJoinOrders(Connection databaseConnection) throws SQLException {
        String sql = "select `ORDER`.ID,U.NAME,G2.NAME,`ORDER`.GOODS_NUM*`ORDER`.GOODS_PRICE from `ORDER` join GOODS G2 on \"ORDER\".GOODS_ID = G2.ID\n" +
                "join USER U on \"ORDER\".USER_ID = U.ID";
        return ordertoList(databaseConnection, sql);
    }
...
// +----------+-----------+------------+-------------+
    public static List<Order> getLeftJoinOrders(Connection databaseConnection) throws SQLException {
        String sql = "select `ORDER`.ID,U.NAME,G2.NAME,`ORDER`.GOODS_NUM*`ORDER`.GOODS_PRICE from `ORDER` left join GOODS G2 on \"ORDER\".GOODS_ID = G2.ID\n" +
                "left join USER U on \"ORDER\".USER_ID = U.ID";
        return ordertoList(databaseConnection, sql);
    }

    public static List<Order> ordertoList(Connection databaseConnection, String sql) throws SQLException {
